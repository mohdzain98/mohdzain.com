    ...
    return (
        <div>
            ...
            <div id='expres' className='mt-4'>
                    ...
                    <div className='col-md-6 col-xs-12'>
                        <div class={`dropdown ${isTabletOrMobile ? "" : "float-end"} pe-4`} id="menu">
                            ...
                            <ul class="dropdown-menu dropdown-menu-lg-end pe-3" style={{ width: 'max-content' }}>
                                ...
                                <li><ScrollLink className='dropdown-item' to='nist' smooth={true} duration={50} style={{ cursor: 'pointer' }}>NIST Randomness Test</ScrollLink></li>
                ...
                <div id='nist'>
                    <h5 className="mt-4" style={{ fontStyle: 'italic' }}>3.7 NIST SP 800-22 Statistical Tests</h5>
                    <div className='row'>
                        <div className='col-md-8 col-xs-12'>
                            <p className='justified'> The NIST randomness test is a statistical test suite developed by the National Institute of Standards and Technology (NIST) to evaluate the randomness of binary sequences from random and pseudo-random number generators. It consists of a battery of empirical tests, such as frequency, block frequency, and runs tests, that assess if a sequence is likely to have come from a random source by looking for non-random patterns.The tests work by formulating a null hypothesis (\(H_{0}\)) that the sequence is random and then computing statistics to see if the sequence deviates from this assumption. <span style={{ color: 'grey' }}>source: Google</span></p>
                            <p className='justified mt-2'>The generated cipher images from the proposed algorithm have been tested using the NIST randomness test
                                suite 25. Table shows the results of the test on the Fruit image of dimension 256 × 256 with three color channels, and their p-values. The test has been done using the nistrng package26. The values in the table,
                                along with the pass results show the random behavior of the generated cipher and the robustness of the proposed algorithm against cryptography attacks.</p>
                        </div>
                        <div className='col-md-4 col-xs-12'>
                            <img src={require('../../Assets/blogs/nist.png')} alt='nist' className='img-fluid' />
                        </div>
                    </div>
