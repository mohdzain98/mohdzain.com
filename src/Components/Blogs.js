    ...
    <div id='blogs' style={{padding:'2%'}}>
        <div className='container p-4' style={{marginTop:'1%'}}>
            ...
            <div style={{margin:'50px 0'}} >
                ...
                <ul className='mt-4' id='aboutBlog'>
                    <li><p className='justified' style={{color:'black'}}>DNA based color images refer to the encoding of the color images into DNA sequences called as DNA computing. By encoding information into DNA strands, scientists can create vast amounts of data storage in a space smaller than a single grain of sand.</p></li>
                    <li><p className='justified' style={{color:'black'}}>Instead of representing images using traditional pixel values the image data is converted into a sequence of DNA nucleotides (Adenine-A, Thymine-T, Cytosine-C and Guanine-G). The process of converting color images's pixel values into a DNA sequence involve mapping the pixel value of a image to specific sequence of DNA bases.</p></li>
                    <li><p className='justified' style={{color:'black'}}>This research used a binary operator to design a cryptosystem that can be used to safely and losslessly encrypt color images in order to demonstrate the operator's viability with  color images as well.</p></li>
                </ul>
