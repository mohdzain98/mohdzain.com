...
- `src/App.js` → `src/pages/home/Home.js` → `src/pages/home/components/Footer.js`
- `src/App.js` → `src/pages/home/Home.js` → `src/pages/home/components/Research.js` → `src/components/layout/Ribbon.js`
- `src/App.js` → `src/pages/home/Home.js` → `src/pages/home/components/Skills.js` → `src/components/layout/Ribbon.js`
- `src/App.js` → `src/pages/home/Home.js` → `src/pages/home/components/Skills.js` → `src/components/Bars/Vertical.js`
- `src/App.js` → `src/pages/home/Home.js` → `src/pages/home/components/Skills.js` → `src/components/Bars/ProgressBar.js`

_(54 additional paths omitted for clarity.)_
...
- **`src/pages/Allprojects.js`**
  - Core logic file referenced by multiple execution paths
- **`home/components/Exp.js`**
  - Core logic file referenced by multiple execution paths
- **`home/components/Projects.js`**
  - Core logic file referenced by multiple execution paths
- **`components/ui/ScrollToTop.js`**
  - Frequently involved in execution flow
